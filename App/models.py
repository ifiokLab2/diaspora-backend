...
class Product(models.Model):
    ...
    slug = models.SlugField(max_length=900, unique=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.pk:
            # Fetch the existing product name from the database to compare
...
class ListingImage(models.Model):
    ...
    image = CloudinaryField('image', folder='listings/gallery/', overwrite=True,resource_type="image",)
